...
namespace SHAM.Repository.Migrations
{
    ...
    [Migration("20210512114316_added_indirectCustomerName")]
    partial class added_indirectCustomerName
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 460, DateTimeKind.Local).AddTicks(2115),
                            CREATED_TIME = new TimeSpan(529954602122),
                        ...
                        new
                        {
                            ...
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 460, DateTimeKind.Local).AddTicks(6767),
                            CREATED_TIME = new TimeSpan(529954606775),
                            INVOICE = false,
                            LOCATION = "Remote",
                            PROJECT_NUMBER = 1,
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 459, DateTimeKind.Local).AddTicks(2220),
                            CREATED_TIME = new TimeSpan(529954592227),
                        ...
                        {
                            ID = 2,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 459, DateTimeKind.Local).AddTicks(4874),
                            CREATED_TIME = new TimeSpan(529954594881),
                        ...
                        {
                            ID = 3,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 459, DateTimeKind.Local).AddTicks(4885),
                            CREATED_TIME = new TimeSpan(529954594886),
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 457, DateTimeKind.Local).AddTicks(3516),
                            CREATED_TIME = new TimeSpan(529954585165),
                        ...
                        {
                            ID = 2,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 459, DateTimeKind.Local).AddTicks(122),
                            CREATED_TIME = new TimeSpan(529954590131),
                        ...
                        {
                            ID = 3,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 459, DateTimeKind.Local).AddTicks(136),
                            CREATED_TIME = new TimeSpan(529954590137),
                        ...
                        {
                            ID = 4,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 459, DateTimeKind.Local).AddTicks(140),
                            CREATED_TIME = new TimeSpan(529954590141),
                            EMPLOYEE_ADRESS = "Üsküdar/İstanbul",
                            EMPLOYEE_CREATOR = 2,
                        ...
                        {
                            ID = 5,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 459, DateTimeKind.Local).AddTicks(146),
                            CREATED_TIME = new TimeSpan(529954590147),
                            EMPLOYEE_ADRESS = "Üsküdar/İstanbul",
                            EMPLOYEE_CREATOR = 2,
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 459, DateTimeKind.Local).AddTicks(6041),
                            CREATED_TIME = new TimeSpan(529954596048),
                            CUSTOMER_NUMBER = 3,
                        ...
                        {
                            ID = 2,
                            CREATED_DATE = new DateTime(2021, 5, 12, 14, 43, 15, 460, DateTimeKind.Local).AddTicks(643),
                            CREATED_TIME = new TimeSpan(529954600651),
                            CUSTOMER_NUMBER = 1,
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.PublicHoliday", b =>
                {
