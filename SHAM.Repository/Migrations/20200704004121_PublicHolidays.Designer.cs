...
namespace SHAM.Repository.Migrations
{
    ...
    [Migration("20200704004121_PublicHolidays")]
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.Activity", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 183, DateTimeKind.Local).AddTicks(6908),
                            CREATED_TIME = new TimeSpan(132801836917),
                        ...
                        new
                        {
                            ...
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 184, DateTimeKind.Local).AddTicks(1296),
                            CREATED_TIME = new TimeSpan(132801841312),
                            INVOICE = false,
                            LOCATION = "Remote",
                            PROJECT_NUMBER = 1,
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.Customer", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 182, DateTimeKind.Local).AddTicks(4028),
                            CREATED_TIME = new TimeSpan(132801824037),
                        ...
                        {
                            ID = 2,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 182, DateTimeKind.Local).AddTicks(7429),
                            CREATED_TIME = new TimeSpan(132801827438),
                        ...
                        {
                            ID = 3,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 182, DateTimeKind.Local).AddTicks(7532),
                            CREATED_TIME = new TimeSpan(132801827535),
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.Employee", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 180, DateTimeKind.Local).AddTicks(590),
                            CREATED_TIME = new TimeSpan(132801815599),
                        ...
                        {
                            ID = 2,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 182, DateTimeKind.Local).AddTicks(750),
                            CREATED_TIME = new TimeSpan(132801820769),
                        ...
                        {
                            ID = 3,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 182, DateTimeKind.Local).AddTicks(981),
                            CREATED_TIME = new TimeSpan(132801820983),
                        ...
                        {
                            ID = 4,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 182, DateTimeKind.Local).AddTicks(989),
                            CREATED_TIME = new TimeSpan(132801820991),
                            EMPLOYEE_ADRESS = "Üsküdar/İstanbul",
                            EMPLOYEE_CREATOR = 2,
                        ...
                        {
                            ID = 5,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 182, DateTimeKind.Local).AddTicks(997),
                            CREATED_TIME = new TimeSpan(132801821001),
                            EMPLOYEE_ADRESS = "Üsküdar/İstanbul",
                            EMPLOYEE_CREATOR = 2,
            ...
            modelBuilder.Entity("SHAM.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ID = 1,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 183, DateTimeKind.Local).AddTicks(100),
                            CREATED_TIME = new TimeSpan(132801830111),
                            CUSTOMER_NUMBER = 3,
                        ...
                        {
                            ID = 2,
                            CREATED_DATE = new DateTime(2020, 7, 4, 3, 41, 20, 183, DateTimeKind.Local).AddTicks(4692),
                            CREATED_TIME = new TimeSpan(132801834707),
                            CUSTOMER_NUMBER = 1,
