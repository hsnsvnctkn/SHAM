    ...
    public partial class m1 : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2019, 12, 11, 16, 13, 0, 762, DateTimeKind.Local).AddTicks(9555), new TimeSpan(583807637883), "Sancaktepe/İstanbul", 1, "sevinctekin.hasan@gmail.com", "Hasan", "05363403660", true, "Sevinçtekin", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 3, new DateTime(2019, 12, 11, 16, 13, 0, 764, DateTimeKind.Local).AddTicks(9163), new TimeSpan(583807649164), "Kadıköy/Istanbul", 1, "supppp@foriba.com.tr", "Foriba", "02163112400", true, "Direct" });

            migrationBuilder.InsertData(
                schema: "SHAM",
                table: "EMPLOYEES",
                columns: new[] { "ID", "CREATED_DATE", "CREATED_TIME", "EMPLOYEE_ADRESS", "EMPLOYEE_CREATOR", "EMPLOYEE_MAIL", "EMPLOYEE_NAME", "EMPLOYEE_PHONE_NO", "EMPLOYEE_STATUS", "EMPLOYEE_SURNAME", "EMPLOYEE_TITLE" },
                values: new object[] { 2, new DateTime(2019, 12, 11, 16, 13, 0, 764, DateTimeKind.Local).AddTicks(2637), new TimeSpan(583807642644), "Kartal/İstanbul", 1, "aaaaasssddn@gmail.com", "Ömer Faruk", "05322545362", true, "Kaya", 1 });

            migrationBuilder.InsertData(
                schema: "SHAM",
                table: "CUSTOMERS",
                columns: new[] { "ID", "CREATED_DATE", "CREATED_TIME", "CUSTOMER_ADRESS", "CUSTOMER_CREATOR", "CUSTOMER_MAIL", "CUSTOMER_NAME", "CUSTOMER_PHONE_NO", "CUSTOMER_STATUS", "CUSTOMER_TYPE" },
                values: new object[] { 1, new DateTime(2019, 12, 11, 16, 13, 0, 764, DateTimeKind.Local).AddTicks(4423), new TimeSpan(583807644430), "Maltepe/Istanbul", 2, "shell123@shell.com.tr", "Shell", "021632145215", true, "Indirect" });

            migrationBuilder.InsertData(
                schema: "SHAM",
                table: "EMPLOYEES",
                columns: new[] { "ID", "CREATED_DATE", "CREATED_TIME", "EMPLOYEE_ADRESS", "EMPLOYEE_CREATOR", "EMPLOYEE_MAIL", "EMPLOYEE_NAME", "EMPLOYEE_PHONE_NO", "EMPLOYEE_STATUS", "EMPLOYEE_SURNAME", "EMPLOYEE_TITLE" },
                values: new object[] { 3, new DateTime(2019, 12, 11, 16, 13, 0, 764, DateTimeKind.Local).AddTicks(2729), new TimeSpan(583807642731), "Üsküdar/İstanbul", 2, "qwwwweeeqq@gmail.com", "Fatih", "05348796582", true, "Balcıoğlu", 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, 2, "Send to Shell when finished", 3, false, new DateTime(2019, 12, 11, 16, 13, 0, 766, DateTimeKind.Local).AddTicks(1561), new TimeSpan(583807661568), new DateTime(2019, 6, 21, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2019, 6, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2019, 5, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 1, new DateTime(2019, 5, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) },
                    { 2, 2, "Notify Mr. Kaya when finished", 3, true, new DateTime(2019, 12, 11, 16, 13, 0, 766, DateTimeKind.Local).AddTicks(7720), new TimeSpan(583807667727), null, new DateTime(2019, 8, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2019, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified), false, 1, new DateTime(2019, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified) }
                });
            ...
            migrationBuilder.InsertData(
                ...
                table: "CUSTOMERS",
                columns: new[] { "ID", "CREATED_DATE", "CREATED_TIME", "CUSTOMER_ADRESS", "CUSTOMER_CREATOR", "CUSTOMER_MAIL", "CUSTOMER_NAME", "CUSTOMER_PHONE_NO", "CUSTOMER_STATUS", "CUSTOMER_TYPE" },
                values: new object[] { 2, new DateTime(2019, 12, 11, 16, 13, 0, 764, DateTimeKind.Local).AddTicks(9083), new TimeSpan(583807649090), "Fatih/Istanbul", 3, "hhhsssqqq@solen.com.tr", "Şölen", "02125422311", true, "Direct" });

            migrationBuilder.InsertData(
                schema: "SHAM",
                table: "PROJECTS",
                columns: new[] { "ID", "CREATED_DATE", "CREATED_TIME", "CUSTOMER_NUMBER", "END_DATE", "ESTIMATE_END_DATE", "ESTIMATE_START_DATE", "PROJECT_CREATOR", "PROJECT_LEVEL", "PROJECT_NAME", "PROJECT_STATUS", "PROJECT_TYPE", "START_DATE" },
                values: new object[] { 2, new DateTime(2019, 12, 11, 16, 13, 0, 765, DateTimeKind.Local).AddTicks(9369), new TimeSpan(583807659376), 1, new DateTime(2019, 12, 17, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2019, 12, 20, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2019, 10, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 3, 3, "Game Simulator", true, 1, new DateTime(2019, 10, 5, 0, 0, 0, 0, DateTimeKind.Unspecified) });
